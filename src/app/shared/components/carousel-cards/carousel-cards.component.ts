...
export class CarouselCardsComponent implements OnInit {
  ...
  ngOnInit(): void 
  {
    ...
    "prevArrow": false,
    "nextArrow": false,event: {beforeChange: function () {},afterChange: function () {}},
  ...
  {
    if(this.objWindowSizeService.checkMaxScreenSize(750))
      this.viewSlide=2;
  ...
  viewProduct(product:any):void
  {
    ...
    if(!this.objRouter.url.includes("/Product/View"))  
      ...
      this.objShareInformationService.reloadSamePage$.emit(product);
  }
}
