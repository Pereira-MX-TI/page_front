...
export class AboutUsComponent implements OnInit,AfterViewInit,OnDestroy 
{
    ...
    public  objNavegationService:NavegationService)
  {
    ...
    this.menuList = [
      {title:"Quienes somos",     status:false,description:"Soluciones Comerciales hidráulicas Pereira S de RL es una empresa mexicana que cuenta con la distribución de la marca medidores Itron y accesorios hidráulicos marca ALFA dedicas a la comercialización e innovación de productos y sistemas de medición de agua, siempre en búsqueda de alternativas que ayuden eficientemente a mejorar la administración y gestión del agua. Nuestras soluciones ayudan a concesionarias de agua Potable en México, empresas públicas y privadas, industrias, fabricas, ferreteras, micronegocios, proyectos y a los pequeños emprendedores."},
      {title:"Nuestra Misión",    status:false,description:"Ofrecer las mejores soluciones en medición de agua a nuestros clientes para que adquieran una mayor seguridad y un mejor control en la gestión del agua, diagnosticando las necesidades y condiciones propias de cada uno de nuestro cliente con el fin de maximizar los beneficios para nuestros clientes y optimicen la distribución, conservación y uso del recurso."},
      {title:"Nuestra Visón",    status:false,description:"Ser la empresa líder en nuestro mercado satisfaciendo a nuestros clientes con nuestra amplia cartera de productos y servicios, por supuesto dando soluciones innovadoras, eficientes y de gran calidad basadas en tecnologías a través de nuevas alianzas estratégicas de nuestros proveedores."}
    ];
