...
import { ShareInformationService } from '../share-information/share-information.service'
...
export class NavegationService {
  ...
  listSelectMenu(urlCurrent: string): any {
    ...
    urlCurrent = urlCurrent.includes('/Product/View')
      ? '/Product/View'
      : urlCurrent
    urlCurrent = urlCurrent.includes('/Service/View')
      ? '/Service/View'
      : urlCurrent
