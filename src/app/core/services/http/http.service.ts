...
import { CryptoService, LocalStorageService } from '@core/services';
...
export class HttpService {
      ...
      case 1:
        {
          ...
          this.HEADERS = new HttpHeaders({
            ...
            Accept: 'application/json',
            Authorization:
              'Bearer ' + this.objCryptoService.decrypted(currentAccount.token),
  ...
  getLogin(data: any): Observable<any> {
    ...
    params = params.append(
      'data',
      btoa(this.objCryptoService.encrypted(data)).replace(
        new RegExp('/', 'g'),
        '~',
      ),
    );
    return this.objHttp.get<any>(`${environment.API_URI}login`, {
  ...
  getListCarousel(data: any): Observable<any> {
    ...
    return this.objHttp.get<any>(
      `${environment.API_URI}${this.versionApi}getListCarousel`,
  ...
  getCarousel(data: any): Observable<any> {
    ...
    return this.objHttp.get<any>(
      `${environment.API_URI}${this.versionApi}getCarousel`,
      { headers: this.HEADERS, params: params },
    );
  }
  ...
  getListProduct(data: any): Observable<any> {
    ...
    return this.objHttp.get<any>(
      `${environment.API_URI}${this.versionApi}getListProduct`,
      { headers: this.HEADERS, params: params },
    );
  }
  ...
  searchListProduct(data: any): Observable<any> {
    ...
    return this.objHttp.get<any>(
      `${environment.API_URI}${this.versionApi}searchListProduct`,
      { headers: this.HEADERS, params: params },
    );
  }
  ...
  autoCompletedProduct(data: any): Observable<any> {
    ...
    return this.objHttp.get<any>(
      `${environment.API_URI}${this.versionApi}autoCompletedProduct`,
      { headers: this.HEADERS, params: params },
    );
  }
  ...
  getProduct(data: any): Observable<any> {
    ...
    return this.objHttp.get<any>(
      `${environment.API_URI}${this.versionApi}getProduct`,
      { headers: this.HEADERS, params: params },
    );
  }
  ...
  getPublicity(data: any): Observable<any> {
    ...
    return this.objHttp.get<any>(
      `${environment.API_URI}${this.versionApi}getPublicity`,
      { headers: this.HEADERS, params: params },
    );
  }
  ...
  registerQuotationWeb(data: any): Observable<any> {
    ...
    return this.objHttp.post<any>(
      `${environment.API_URI}${this.versionApi}registerQuotationWeb`,
      body,
      { headers: this.HEADERS },
    );
  }
  ...
  registerInfoServiceWeb(data: any): Observable<any> {
    ...
    const body = { data: this.objCryptoService.encrypted(data) };
    return this.objHttp.post<any>(
      `${environment.API_URI}${this.versionApi}registerInfoServiceWeb`,
      body,
      { headers: this.HEADERS },
    );
  }
